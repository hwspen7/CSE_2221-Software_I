...
public final class StringReassembly {
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet, String str) {
        ...
        boolean addStr = true;
        Set<String> toRemove = strSet.newInstance();
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        while (!input.atEOS()) {
            ...
            addToSetAvoidingSubstrings(strSet, line);
        }
        return strSet;
    }
     ...
     * </pre>
     */
    public static int bestOverlap(Set<String> strSet, String[] bestTwo) {
        assert strSet != null : "Violation of: strSet is not null";
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        String formattedText = text.replace("~", System.lineSeparator());
    ...
    public static void main(String[] args) {
        ...
        String inputFileName = "data/" + in.nextLine();
