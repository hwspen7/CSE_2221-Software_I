...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    /**
     * Constant for the start index of the last row of digit buttons.
     */
    private static final int LAST_ROW_START = 7;

    /**
     * Constant for the start index of the second row of digit buttons.
     */
    private static final int SECOND_ROW_START = 4;

    /**
     * Constant for the total number of digit buttons.
     */
    ...
    public NNCalcView1() {
         ...
         * to bottom
         */
        for (int i = LAST_ROW_START; i < TOTAL_DIGITS; i++) {
            mainButtonPanel.add(this.bDigits[i]);
        }
        mainButtonPanel.add(this.bAdd);
        for (int i = SECOND_ROW_START; i < LAST_ROW_START; i++) {
            mainButtonPanel.add(this.bDigits[i]);
        }
