...
/**
 * The {@code Newton1} class provides a method to calculate the square root of a
 * positive number using the Newton-Raphson method. It interacts with the user
 * through simple input and output streams to perform multiple calculations
 * based on user input.
 *
 * <p>
 ...
 * Do you want to calculate square root? y/n:
 * n
 * </pre>
 *
 * @author Spencer
...
public final class Newton1 {
    ...
    /**
     * Private constructor to prevent instantiation of the {@code Newton1}
     * class.
     */
    private Newton1() {
    }
     ...
     * relative error is less than a specified epsilon value.
     *
     * @param x
    ...
    private static double sqrt(double x) {
        ...
        // Ensure relative error is no more than 0.01%
