...
public abstract class ListTest {
    ...
    /**
     * Tests retreat() when the left side is empty.
     */
    @Test
    public final void testRetreatLeftEmptyRightEmpty() {
        List<String> list1 = this.createFromArgsTest(0);
        ...
        assertEquals(true, assertionErrorThrown);
    }

    /**
     * Tests retreat() when the left side has one element and the right is
     * empty.
     */
    @Test
    ...
    /**
     * Tests retreat() when the left side has one element and the right has one
     * element.
     */
    @Test
    ...
    /**
     * Tests retreat() when the left side has multiple elements and the right is
     * empty.
     */
    @Test
    public final void testRetreatLeftMultipleRightEmpty() {
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange", "purple");
        List<String> list2 = this.createFromArgsRef(2, "yellow", "orange", "purple");
    ...
    /**
     * Tests retreat() when the left side has multiple elements and the right
     * has one element.
     */
    @Test
    public final void testRetreatLeftMultipleRightOne() {
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange", "purple",
                "red");
        List<String> list2 = this.createFromArgsRef(2, "yellow", "orange", "purple",
                "red");
    ...
    /**
     * Tests retreat() when both left and right sides have multiple elements.
     */
    @Test
    public final void testRetreatLeftMultipleRightMultiple() {
        List<String> list1 = this.createFromArgsTest(2, "yellow", "orange", "green",
                "blue");
        List<String> list2 = this.createFromArgsRef(1, "yellow", "orange", "green",
                "blue");
    ...
    /**
     * Tests retreat() multiple times to ensure correct cursor movement.
     */
    @Test
    public final void testRetreatMultipleSteps() {
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange", "purple",
                "red", "blue");
        List<String> list2 = this.createFromArgsRef(1, "yellow", "orange", "purple",
                "red", "blue");
...
//    /**
//     * Tests retreat multiple times when initially the left list has only one
//     * element.
//     */
//    @Test
//    public final void testRetreatLeftOneMultipleTimes() {
//        /*
//         * Set up variables
//         */
...
//
//        /*
//         * Call retreat once (should work)
//         */
//        list1.retreat();
//
//        /*
//         * Assert that values of variables match expectations after first
//         * retreat
//         */
//        assertEquals(list2, list1);
//
//        /*
//         * Call retreat again (should fail)
//         */
//        list1.retreat(); // Expected: AssertionError
//    }

    /**
     * Tests retreat() when the left side has one element and the right has
     * multiple elements.
     */
    @Test
    public final void testRetreatLeftOneRightMultiple() {
        List<String> list1 = this.createFromArgsTest(1, "red", "blue", "yellow", "green",
                "purple");
        List<String> list2 = this.createFromArgsRef(0, "red", "blue", "yellow", "green",
                "purple");
...
//    /**
//     * Tests retreat() multiple times when left has one element and right has
//     * multiple elements.
//     */
//    @Test
//    public final void testRetreatLeftOneRightMultipleSteps() {
//        List<String> list1 = this.createFromArgsTest(1, "red", "blue", "yellow", "green",
//                "purple");
//        List<String> list2 = this.createFromArgsRef(0, "red", "blue", "yellow", "green",
//                "purple");
//
//        list1.retreat(); // First call: should work
//        assertEquals(list2, list1);
//
//        list1.retreat(); // Second call: should throw an assertion error
//    }

    /**
     * Tests retreat() multiple times when both left and right lists have
     * multiple elements.
     */
    @Test
    public final void testRetreatMultipleStepsLeftAndRight() {
        List<String> list1 = this.createFromArgsTest(3, "red", "blue", "green", "yellow",
                "orange", "purple", "brown");
        List<String> list2 = this.createFromArgsRef(1, "red", "blue", "green", "yellow",
                "orange", "purple", "brown");
     ...
     */
    @Test
    public final void testRetreatLeftOneMultipleTimes_Success() {
        List<String> list1 = this.createFromArgsTest(1, "red", "blue", "green");
        List<String> list2 = this.createFromArgsRef(0, "red", "blue", "green");
    ...
    /**
     * Tests retreat() when left list is empty after one retreat.
     */
    @Test
    public final void testRetreatLeftOneMultipleTimes_Failure() {
        List<String> list1 = this.createFromArgsTest(1, "red", "blue", "green");
     ...
     */
    @Test
    public final void testRetreatLeftOneRightMultipleSteps_Success() {
        List<String> list1 = this.createFromArgsTest(1, "red", "blue", "yellow", "green",
                "purple");
        List<String> list2 = this.createFromArgsRef(0, "red", "blue", "yellow", "green",
                "purple");
     ...
     */
    @Test
    public final void testRetreatLeftOneRightMultipleSteps_Failure() {
        List<String> list1 = this.createFromArgsTest(1, "red", "blue", "yellow", "green",
                "purple");
